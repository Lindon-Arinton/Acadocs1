...
class PerformanceController extends BaseApiController
{
    public function index()
    {
        ...
        return $this->jsonResponse([
            ...
            'by_level'   => (new PerformanceByLevelModel())->where('school_year', $schoolYear)->orderBy('grade_level')->findAll(),
            'by_subject' => (new PerformanceBySubjectModel())->where('school_year', $schoolYear)->orderBy('mps', 'DESC')->findAll(),
