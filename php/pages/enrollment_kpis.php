...
requireLogin();
define('PAGE_TITLE', 'Enrollment KPIs');
$db = getDB();
...
$enrollment = $db->prepare("SELECT * FROM enrollment_by_level WHERE school_year=? ORDER BY grade_level");
$enrollment->execute([$year]); $enrollment = $enrollment->fetchAll();
